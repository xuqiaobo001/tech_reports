...
| **对象总数** | 200,000 |
| **预计写入/读取数据量** | 781.2 MB |
| **计算公式** | Users(1) × ThreadsPerUser(100) × BucketsPerUser(1) × ObjectsPerBucketPerThread(2000) = **200,000** |
...
| **对象总数** | 500,000 |
| **预计写入/读取数据量** | 1.9 GB |
| **计算公式** | Users(1) × ThreadsPerUser(500) × BucketsPerUser(1) × ObjectsPerBucketPerThread(1000) = **500,000** |
